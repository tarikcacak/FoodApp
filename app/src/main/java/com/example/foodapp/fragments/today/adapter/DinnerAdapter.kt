...
class DinnerAdapter() : RecyclerView.Adapter<DinnerAdapter.DinnerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DinnerViewHolder {
        return DinnerViewHolder(TypeItemBinding.inflate(LayoutInflater.from(parent.context)))
    }
